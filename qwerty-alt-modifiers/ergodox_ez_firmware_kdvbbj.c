...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = KEYMAP(KC_EQUAL,KC_1,KC_2,KC_3,KC_4,KC_5,KC_ESCAPE,KC_TAB,KC_Q,KC_W,KC_E,KC_R,KC_T,TG(1),KC_BSPACE,KC_A,KC_S,KC_D,KC_F,KC_G,KC_LSHIFT,KC_Z,KC_X,KC_C,KC_V,KC_B,ALL_T(KC_NO),KC_LCTL,KC_F15,KC_F14,KC_LEFT,KC_RIGHT,ALT_T(KC_APPLICATION),KC_LGUI,KC_LBRACKET,KC_SPACE,KC_BSPACE,KC_PGUP,KC_GRAVE,KC_6,KC_7,KC_8,KC_9,KC_0,KC_MINUS,MEH_T(KC_NO),KC_Y,KC_U,KC_I,KC_O,KC_P,KC_BSLASH,KC_H,KC_J,KC_K,KC_L,KC_SCOLON,KC_QUOTE,SCMD_T(KC_NO),KC_N,KC_M,KC_COMMA,KC_DOT,KC_SLASH,KC_LSHIFT,KC_LEFT,KC_DOWN,KC_UP,KC_RIGHT,KC_SYSTEM_SLEEP,KC_LALT,CTL_T(KC_ESCAPE),KC_RBRACKET,KC_PGDOWN,KC_TAB,KC_ENTER),
